// @ts-nocheck
// <!------- time is 2024-04-24 19:26:15 UTC -------!>
// @ts-ignore
...
const proxyIPs= ['138.3.254.39', '130.61.23.77', '45.142.115.59'];// OR USE ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'workers.cloudflare.cyou'];
...
const renderLoginPage = async () => {
    ...
    <body>
        <div class="container">
            <h2>🔰 BPB Panel v2.3.4 🔰<span style="font-size: smaller;"></span></h2>
            <div class="form-container">
                <h2>User Login</h2>
                <form id="loginForm">
                    <div class="form-control">
